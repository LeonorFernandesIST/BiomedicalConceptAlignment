...
class RTransformerModelEmb(pl.LightningModule):
    def __init__(self, name, train_dataset, test_dataset, rnn_type='GRU'):
        super(RTransformerModelEmb, self).__init__()
        self.hidden_size = 512
...
class RMogrifierTransformerModel(RTransformerModelEmb):
